...
// Pestañas nuevas: las columnas cambiaron y las viejas ("Valorant" /
// "Fortnite") quedan como archivo con sus encabezados antiguos.
export const SHEET_VALORANT = 'Valorant 2';
export const SHEET_FORTNITE = 'Fortnite 2';
...
const COMMON_TAIL = ['skins', 'precio', 'skins_destacadas', 'recibos', 'cuotas', 'notas'];
...
export const COLUMNS_FORTNITE = [
  ...
  'correo_completo', 'cambio_correo_ugi', 'historial_recuperacion',
