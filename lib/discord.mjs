...
export async function anunciarCuenta(cuenta) {
  ...
  // El preview del embed muestra el LOGO de la página (no una foto del inventario).
  embed.image = { url: `${siteUrl}/logotrustifymarket.jpeg` };

  // Descarga TODAS las fotos de la cuenta y las sube como adjuntos: se muestran
  // debajo del mensaje, después del embed con los detalles.
